...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$whistler_cabins_description = get_bloginfo( 'description', 'display' );
			if ( $whistler_cabins_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $whistler_cabins_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
